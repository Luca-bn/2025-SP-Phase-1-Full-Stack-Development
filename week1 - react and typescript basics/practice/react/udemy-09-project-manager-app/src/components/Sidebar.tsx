...
export type SidebarImperativeHandle = {
    saveProject: (project: ProjectType) => void,
    deleteProject: (toDelete: ProjectType | null) => void,
    deselectProject: () => void
}

type SidebarProps = {
    onNewProject: () => void, onProjectSelect: (project: ProjectType) => void, props?: unknown[]
}

const Sidebar = forwardRef(({ onNewProject, onProjectSelect, ...props }: SidebarProps, ref) => {

    const [projects, setProjects] = useState<ProjectType[]>(MOCKED_PROJECTS);
    const [selectedProjectId, setSelectedProjectId] = useState<number | null | undefined>();
    ...
    useImperativeHandle(ref, () => {
        return {
            ...
            deleteProject: (toDelete: ProjectType) => {
                setProjects((prev) => {
                    return prev
