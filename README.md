...
|     | - Debug any issues in your Todo List app.                    | [X]  |              |
|     | - Optimize code structure.                                   | [X]  |              |
|     | - Watch React TypeScript Tutorial.                           | [X]  |              |
| 7   | **Weekly Review**                                            |      | 2            |
|     | - Reflect on progress.                                       | [X]  |              |
|     | - Plan adjustments for Week 2.                               | [X]  |              |
...
| --- | ------------------------------------------------------------------- | ---- | ------------ |
| 15  | **Node.js Basics**                                                  |      | 6            |
|     | - Install Node.js and set up a project.                             | [X]  |              |
|     | - Read Node.js Docs: Getting Started.                               | [ ]  |              |
|     | - Build a simple "Hello World" server.                              | [X]  |              |
